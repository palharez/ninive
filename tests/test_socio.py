...
class TestSocio(unittest.TestCase):
    ...
    def test_get_socios(self):
        insert('INSERT INTO socio values (default, "Eduardo Junior", "1234567891", "1997-07-16", "eduardopalhares@email.com", default, "Eduardo P", "Adriana S", "Cotia", "Jd. Rio das Pedras", "Rua Potengi, 609", "609", "1234567", "123456789", "123456789", "who.png", default)') 
    ...
    def test_retorna_200_quando_cria_um_socio(self):
        json = {
        ...
        response = self.app_test.post('/socio/create', data=json)      
        self.assertEqual(200, response.status_code)

    def test_retorna_200_quando_atualiza_um_socio_criado(self):
        insert('INSERT INTO socio values (default, "Eduardo Junior", "1234567891", "1997-07-16", "eduardopalhares@email.com", default, "Eduardo P", "Adriana S", "Cotia", "Jd. Rio das Pedras", "Rua Potengi, 609", "609", "1234567", "123456789", "123456789", "who.png", default)') 
        json = {
